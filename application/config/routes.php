...
$route['admin/attributes/create'] = 'admin/create_attribute';
$route['admin/attributes/edit/(:num)'] = 'admin/edit_attribute/$1';
$route['admin/attributes/delete/(:num)'] = 'admin/delete_attribute/$1';
