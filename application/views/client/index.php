...
?>
        ...
        <?php
            ...
            <?php if(get_setting('freebies') == true) {?>
    <div class="catalog_layout">
        <h3>Freebies</h3>
        <div class="catalog_grid">
                    ...
                    <a href="<?php echo site_url('detail-product/'.$product->id); ?>">
                        <div class="image_grid">
                            ...
                            <div class="price_grid">
                                ...
                                ?>
                                <span><?php if($product->price == 0){ echo "Gratis"; }else if($product->discount == true){ echo "<strike style='color:red;'>".get_setting('mata_uang'). number_format($product->price, 0, '', get_setting('number_format'))."</strike><br><p>".get_setting('mata_uang').number_format($price_after_discount, 0, '', get_setting('number_format'))."</p>" ; }else{ echo get_setting('mata_uang')." ". number_format($product->price, 0, '', get_setting('number_format')); } ?></span>
                            </div>
                        </div>
                            <div class="content_grid">
                                <h4><?php echo $product->name; ?></h4>
